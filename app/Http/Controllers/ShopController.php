    ...
    public function productDetails($slug)
{
    ...
    // Mendapatkan 8 produk secara acak yang slug-nya tidak sama dengan produk saat ini
    $arproducts = Product::where('slug', '!=', $slug)->inRandomOrder('id')->get()->take(8);

    // Mengirimkan data ke view 'details'
    return view('details', ['product' => $product, 'arproducts' => $arproducts]);
}
