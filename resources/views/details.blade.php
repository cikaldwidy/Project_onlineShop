                                        ...
                                        <div class="details-image-1 ratio_asos">
                                            ...
                                            @if ($product->images)
                                                ...
                                                @foreach ($images as $image)
                                                    <div>
                                                        <img src="{{ asset('/assets/images/fashion/product/front/' . $image) }}"
                                                            class="img-fluid blur-up lazyload w-100 image_zoom_cls-1"
                                                            data-zoom-image="{{ asset('/assets/images/fashion/product/front/' . $image) }}"
                                                            alt="">
                                                    </div>
                                                @endforeach
                                            @endif
                                    ...
                                    <div class="product-details">
                                        ...
                                        <div class="main-price">
                                            ...
                                            <div class="listing-content">
                                                <span class="font-light">{{ $arproduct->category->name }}</span>
                                                <p class="font-light">{{ $arproduct->short_description }}</p>
                                            </div>
                                            <h3 class="theme-color">
                                                @if ($arproduct->sale_price)
                                                    {{ $product->sale_price }}
                                                @else
                                                    {{ $arproduct->regular_price }}
                                                @endif
                                            </h3>
