    ...
    <section class="pt-0 poster-section">
        ...
        <div class="left-side-contain">
            <div class="banner-left">
                ...
                <h1>New Latest <span>Hoddie</span></h1>
                <p>Promo Diskon Musim Dingin <span class="theme-color">FREE</span></p>
                <h2>$65.00 <span class="theme-color"><del>$95.00</del></span></h2>
                <p class="poster-details mb-0">Bersiaplah untuk tampil keren dan hangat dengan koleksi hoodie terbaru kami.
                    Nikmati diskon hingga 50% untuk semua hoodie!</p>
            </div>
        </div>
