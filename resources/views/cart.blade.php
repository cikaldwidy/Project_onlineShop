    ...
    <section class="cart-section section-b-space">
        <div class="container">
                        ...
                        <div class="row g-4">
                            <div class="col-lg-4 col-sm-6">
                                <div class="promo-section">
                                    <form class="row g-3">
                                        ...
                                        <div class="col-5">
                                            <button class="btn btn-solid-default rounded btn">Klaim Voucher</button>
                            ...
                            <div class="col-lg-4 col-sm-6 ">
                                <div class="checkout-button">
                                    <a href="{{ route('order.create') }}" class="btn btn-solid-default btn fw-bold">
                                    ...
                                    <div class="cart-box-details">
                                        <div class="total-details">
                                            ...
                                            <div class="bottom-details">
                                                <a href="{{ route('order.create') }}">Process Checkout</a>
            ...
            @else
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h2>Wah, keranjangmu kosong!</h2>
                        <h5 class="mt-3">Kelola keranjangmu sekarang!.</h5>
                        <a href="{{ route('shop.index') }}" class="btn btn-warning mt-5">Klik Now</a><br>
                        <li><a href="{{ route('orders.index') }} "class="btn btn-warning mt-5">Pesanan Saya</a></li>
                    </div>
                </div>
            @endif
