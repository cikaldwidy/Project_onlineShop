                                    ...
                                    <div class="img-wrapper">
                                        ...
                                        <div class="cart-wrap">
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="javascript:void(0)"
                                                        onclick="addProductTwoWishlist({{ $product->id }},'{{ $product->name }}',1,{{ $product->regular_price }})"
                                                        class="wishlist">
            ...
            <div class="row">
                <div class="col-lg-8 col-md-6">
                    <div class="subscribe-details">
                        <h2 class="mb-3">Berlangganan Berita Kami</h2>
                        <h6 class="font-light">Berlangganan dan terima buletin kami untuk mengikuti berita terbaru kami
                            dan Produk yang fantastis.</h6>
                    </div>
                </div>
...
@push('scripts')
    <script>
        ...
        function addProductTwoWishlist(id, name, quantity, price) {
            $.ajax({
                type: 'POST',
